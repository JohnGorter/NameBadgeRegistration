...
<html>
  <head>
    ...
    <script type="module" src="../iron-flex-layout-classes.js"></script>
...
$_documentContainer.innerHTML = `<test-fixture id="basic">
      <template>
...
$_documentContainer.innerHTML = `<test-fixture id="flex">
      <template>
        <div class="container layout">
...
$_documentContainer.innerHTML = `<test-fixture id="single-child">
      <template>
        <div class="container layout">
          <div id="c1"></div>
        </div>
...
$_documentContainer.innerHTML = `<test-fixture id="positioning">
      <template>
...
$_documentContainer.innerHTML = `<test-fixture id="align-content">
      <template>
        <div class="container layout">
          <div id="c1"></div>
          <div id="c2"></div>
