...
<head>
  ...
  <script type="module" src="./test-scrollable.js"></script>
...
import { elementIsScrollLocked, _lockingElements } from '../iron-scroll-manager.js';
...
suite('scroll actions in shadow root, overlay distributed', function() {
  ...
  setup(function() {
    var f = fixture('scrollable');
    scrollable = f.$.scrollable;
    overlay = dom(f).querySelector('test-overlay');
  });
