...
<html>
  <head>
    ...
    <script type="module" src="./test-menu.js"></script>
    <script type="module" src="./test-nested-menu.js"></script>
...
suite('menu a11y tests', function() {
  ...
  test('focusing on item with multi-char ignoring modifier keys, quick input', function(done) {
    var menu = fixture('countries');
    waitForIronItemsChanged(menu, function() {
      MockInteractions.focus(menu);
  ...
  test('focusing non-item content does not auto-focus an item', function(done) {
    ...
    waitForIronItemsChanged(menu, function() {
      ...
      Base.async(function() {
        ...
        assert.equal(dom(document).activeElement, menu, 'menu is document.activeElement');
        done();
      });
    });
  });
