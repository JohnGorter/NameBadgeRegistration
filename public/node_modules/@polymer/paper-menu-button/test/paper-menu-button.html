...
<head>
  ...
  <script type="module" src="../paper-menu-button.js"></script>
...
suite('<paper-menu-button>', function() {
  ...
  setup(function() {
    ...
    trigger = dom(menuButton).querySelector('[slot="dropdown-trigger"]');
    content = dom(menuButton).querySelector('[slot="dropdown-content"]');
  });
...
suite('when there are two buttons', function() {
  ...
  setup(function() {
    ...
    trigger = dom(menuButton).querySelector('[slot="dropdown-trigger"]');
    otherTrigger = dom(otherButton).querySelector('[slot="dropdown-trigger"]');
  });
