...
<head>
  ...
  <script type="module" src="../paper-dialog.js"></script>
  <script type="module" src="../../paper-button/paper-button.js"></script>
  <script type="module" src="../../paper-dialog-scrollable/paper-dialog-scrollable.js"></script>
  <link rel="import" href="../../neon-animation/web-animations.html">
  <script type="module" src="../../neon-animation/neon-animations.js"></script>
  <script type="module" src="../../paper-dropdown-menu/paper-dropdown-menu-light.js"></script>
  <script type="module" src="../../paper-listbox/paper-listbox.js"></script>
  <script type="module" src="../../paper-item/paper-item.js"></script>
...
<body unresolved class="centered">
  <script type="module">
const $_documentContainer = document.createElement('div');
$_documentContainer.innerHTML = `<h3>Dialog layouts</h3>`;
document.body.appendChild($_documentContainer);
</script>
  <script type="module">
const $_documentContainer = document.createElement('div');
...
document.body.appendChild($_documentContainer);
  ...
  <script type="module">
const $_documentContainer = document.createElement('div');
$_documentContainer.innerHTML = `<h3>Styling and positioning</h3>`;
document.body.appendChild($_documentContainer);
</script>
  <script type="module">
const $_documentContainer = document.createElement('div');
...
document.body.appendChild($_documentContainer);
  ...
  <script type="module">
const $_documentContainer = document.createElement('div');
$_documentContainer.innerHTML = `<h3>Position with <code>positionTarget</code></h3>`;
document.body.appendChild($_documentContainer);
</script>
  <script type="module">
const $_documentContainer = document.createElement('div');
...
document.body.appendChild($_documentContainer);
</script>r/neon-animation/neon-animations.js';
...
function openBy(element) {
  ...
  <script type="module">
const $_documentContainer = document.createElement('div');
$_documentContainer.innerHTML = `<h3>Transitions with neon-animation</h3>`;
document.body.appendChild($_documentContainer);
</script>
  <script type="module">
const $_documentContainer = document.createElement('div');
