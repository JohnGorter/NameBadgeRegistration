...
<head>
  ...
  <script type="module" src="../iron-iconset-svg.js"></script>
  <script type="module" src="../../iron-meta/iron-meta.js"></script>
  <script type="module" src="../../iron-icon/iron-icon.js"></script>
  <script type="module" src="../../promise-polyfill/promise-polyfill.js"></script>
...
import '/node_modules/@polymer/promise-polyfill/promise-polyfill.js';
import '/node_modules/@polymer/test-fixture/test-fixture.js';
import { flush, dom } from '/node_modules/@polymer/polymer/lib/legacy/polymer.dom.js';
...
suite('<iron-iconset>', function() {
  ...
  suite('Adding / removal from iron-icon', function () {
    ...
    test('be able to remove an iconset from a Polymer element', function () {
      var baseLength = dom(ironIcon.root).children.length;
      iconset.applyIcon(ironIcon, 'circle');
      flush();
      expect(dom(ironIcon.root).children.length - baseLength).to.be.equal(1);
      iconset.removeIcon(ironIcon);
      flush();
      expect(dom(ironIcon.root).children.length - baseLength).to.be.equal(0);
    });
