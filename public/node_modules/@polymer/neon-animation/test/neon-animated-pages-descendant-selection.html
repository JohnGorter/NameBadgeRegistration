...
<script type="module" src="../neon-animation-behavior.js"></script>
<script type="module" src="../../iron-selector/iron-selector.js"></script>
...
suite('descendant selection', function() {
  ...
  test('elements distributed as children are animated', function() {
    ...
    var animatedPages = dom(testElement.root).querySelector("neon-animated-pages");
