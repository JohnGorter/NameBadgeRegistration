...
suite('multi', function() {
  ...
  test('fires selected-values-changed when selection changes', function() {
    ...
    MockInteractions.tap(dom(s).children[0]);
    MockInteractions.tap(dom(s).children[0]);
    MockInteractions.tap(dom(s).children[0]);
  ...
  test('selects from items created by dom-repeat', function(done) {
    ...
    Base.async(function() {
      var firstChild = dom(selector).querySelector('div');
  ...
  test('updates selection when dom changes', function() {
    var firstChild = dom(s).querySelector(':first-child');
    var lastChild = dom(s).querySelector(':last-child');
