...
<head>
  ...
  <script type="module" src="../paper-toolbar.js"></script>
...
import { dom, flush as flush$0 } from '/node_modules/@polymer/polymer/lib/legacy/polymer.dom.js';
...
suite('a11y', function() {
  ...
  test('existing ids on titles are preserved', function() {
    ...
    assert.isTrue(toolbar.hasAttribute('aria-labelledby'), 'has aria-labelledby');
    assert.equal(dom(toolbar).querySelector('.title').id, 'title', 'id is preserved');
  });
