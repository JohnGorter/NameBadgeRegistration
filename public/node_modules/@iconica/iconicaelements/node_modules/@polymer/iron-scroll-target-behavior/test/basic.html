...
<head>
  ...
  <script type="module" src="./x-scrollable.js"></script>
  <script type="module" src="./x-nested-scrollable.js"></script>
...
suite('basic features', function() {
  ...
  setup(function() {
    ...
    xScroll = dom(scrollingRegion).querySelector('x-scrollable');
  });
...
suite('scrolling region', function() {
  ...
  setup(function() {
    ...
    xScrollable = dom(scrollingRegion).querySelector('x-scrollable');
  });
