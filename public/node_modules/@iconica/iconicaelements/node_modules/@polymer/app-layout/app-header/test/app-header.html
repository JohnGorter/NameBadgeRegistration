...
import { flush as flush$0 } from '/node_modules/@polymer/polymer/lib/legacy/polymer.dom.js';
...
suite('basic features', function() {
  ...
  suiteSetup(function() {
    ...
    registerEffect('test-effect', testEffect);
  });
...
suite('Sticky element', function() {
  ...
  test('sticky element reference', function() {
    flush$0();
    assert.equal(header._stickyEl, header.querySelector('[sticky]'));
  });
