...
<head>
  <meta charset="UTF-8">
  <title>test for the parallax-background effect</title>
  ...
  <script type="module" src="../app-scroll-effects.js"></script>
  <script type="module" src="./x-container.js"></script>
...
<body>
  ...
  <test-fixture id="testHeader">
    <template>
      <x-container effects="parallax-background"></x-container>
    </template>
  </test-fixture>

  <script type="module">
import '/node_modules/@polymer/test-fixture/test-fixture.js';
import '../app-scroll-effects.js';
